...
if( ! class_exists( 'aptc_WooCommerce_Hooks' ) ) :

    class aptc_WooCommerce_Hooks {
        ...
        /**
         * aptc WooCommerce Theme Support
         */
...
return new aptc_WooCommerce_Hooks();
