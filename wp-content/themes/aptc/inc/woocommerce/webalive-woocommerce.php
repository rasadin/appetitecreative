...
if( !class_exists( 'aptc_WooCommerce' ) ) :

    /**
     * The aptc WooCommerce Integration Class
     */
    class aptc_WooCommerce {
        ...
        /**
         * aptc WooCommerce Scripts
         * 
         * @since 1.0.0
         */
        public function woocommerce_scripts() {
		    wp_enqueue_style( 'aptc-woo-style', get_template_directory_uri() . '/woocommerce.css' );  
        }
		...
		public function related_products_args( $args ) {
			$args = apply_filters( 'aptc_related_products_args', array(
				'posts_per_page' => 3,
				'columns'        => 3,
			) );
